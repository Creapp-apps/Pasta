...
export default function Loading() {
   return (
      <div className="flex flex-col items-center justify-center min-h-[55vh] w-full gap-5 animate-in fade-in duration-300">
         <style>{`
            @keyframes steam {
         ...
         <div className="text-center">
            <h4 className="font-extrabold text-slate-800 text-sm tracking-widest uppercase">Cocinando...</h4>
            <p className="text-xs text-slate-400 font-bold mt-1">Preparando pastas frescas e inventario</p>
         </div>
      </div>
   )
}
